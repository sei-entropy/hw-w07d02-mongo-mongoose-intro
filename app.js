...
//           }
//         });
// Vampire.find({$and:	[{title:{$exists:true}},{victims:{$exists:false}}]},(err,vampires)=>{
//   if(err){
//  console.log(err)
//   }else{
//  console.log(vampires)
// }
// });
// Vampire.find({$and:[{title:{$exists:true}},{victims:{$gt:1000}}]},(err,vampires)=>{
//   if(err){
//  console.log(err)
//   }else{
//  console.log(vampires)
...
// Vampire.find({ $or: [ { loves: {$in: ['frilly shirts']} }, { loves: {$in: ['frilly collars']} } ]},
//  (err,vampires)=>{
//              if(err){
//             console.log(err)
//              }else{
...
//         });
  ...
  //Negative Selection
    ...
    //                             }
    //                           });
// Vampire.find({location:{$not:{$regex:'Rome'}}},
// (err,vampires)=>{                         
//   if(err){
// console.log(err)
//  }else{
...
//           });
//Update
// Vampire.findOneAndUpdate({ name: 'Guy Manve' },  {gender: 'f'} ,
// (err,vampires)=>{                          
//         if(err){
//           console.log(err)
//            }else{
...
//           }
//             });
// Vampire.findOneAndUpdate({name: 'Guy Man' }, { $push: { hates:  ['alarm clocks', 'jackalopes'] } }, 
// (     err,vampires)=>{                          
//         if(err){
//           console.log(err)
//            }else{
